<template>
  <div>
    ...
    <section class="section section-padding">
      ...
      <p class="has-text-weight-bold">Photo URL:</p>
      <p>{{ formData.photo_url }}</p>
      <div class="formViewSeparator"></div>

      <p class="has-text-weight-bold">Is admin:</p>
      <p>
        <span class="tag is-success" v-if="formData.is_admin == true">yes</span>
